...
class StudentUpcomingDutyAdapter(private var duties: MutableList<Duty>) : RecyclerView.Adapter<StudentUpcomingDutyAdapter.DutyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DutyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.rv_student_duty_card, parent, false)
